	...
	public int checkObject(Entity entity, boolean player) {
		...
		for (int i = 0; i < gp.getSuperObject().length; i++) {
			...
			if (gp.getSuperObject()[i] != null) {
				...
				gp.getSuperObject()[i].solidArea
						.setX(gp.getSuperObject()[i].worldX + gp.getSuperObject()[i].solidArea.getX());
				gp.getSuperObject()[i].solidArea
						.setY(gp.getSuperObject()[i].worldY + gp.getSuperObject()[i].solidArea.getY());
